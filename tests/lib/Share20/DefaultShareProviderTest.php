...
class DefaultShareProviderTest extends TestCase {
	...
	public function testGetAllSharesBy() {
		...
		$share = $this->provider->getAllSharesBy('sharedBy', [Share::SHARE_TYPE_USER], null, false);
		$this->assertCount(1, $share);
	...
	public function testGetAllSharesByNode() {
		$qb = $this->dbConn->getQueryBuilder();
		$qb->insert('share')
			->values([
				'share_type' => $qb->expr()->literal(Share::SHARE_TYPE_USER),
		...
		$share = $this->provider->getAllSharesBy('sharedBy', [Share::SHARE_TYPE_USER], $file, false);
		$this->assertCount(1, $share);
